...
| <a name="input_identity"></a> [identity](#input\_identity) | n/a | <pre>object({<br/>    identity_ids = optional(set(string)),<br/>    principal_id = string,<br/>    tenant_id    = string,<br/>    type         = string<br/>  })</pre> | `null` | no |
